...
if (($_SESSION["Adminlvl"] === 0) || ($_SESSION["Adminlvl"] === null)) {
  ...
  header("location: signup.php?error=lmao man");
   exit();
}
...
include_once 'Sidebar.php';
 ...
 <body>
   <form id="edittext" action="includes/Savetodolist.inc.php" method="post">
     <div class="Edditingtable">

<input class="headertext" id="headertext"name="headertxt" placeholder="Subject" maxlength="40"></input>
<div id="headercount">
  <span id="headercurrent">0</span>
  <span id="headermaximum">/40</span>

</div>
<textarea class="Bodytext" id="bodytext"placeholder="" name="bodytxt" maxlength="600" ></textarea>

  <div class="Editlistbuttons">
	<button class="Cancle" type="submit" name="Canclebtn" >Cancle</button>
	<button class="Savelist" type="submit" name="Savetodb">Save</button>
  <div id="bodycount">
